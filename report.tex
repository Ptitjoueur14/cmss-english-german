...
\begin{titlepage}
    \begin{center}
        ...
        \textbf{Does cross-platform social media usage increase the spread of English words in German social media networks?}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.5]{adoption_rate_by_number_of_initial_adopters.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.5]{adoption_rate_by_platform.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.5]{adoption_rate_by_platform_influencer.png}
