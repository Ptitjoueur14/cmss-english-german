...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.60]{adoption_rate_by_number_of_initial_adopters.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.60]{adoption_rate_by_platform.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.60]{adoption_rate_by_platform_influencer.png}
